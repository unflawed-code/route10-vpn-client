...
if [ ! -f /tmp/dhcp.leases ] && [ ! -f /var/dhcp.leases ] && [ ! -f /cfg/dhcp.leases ]; then
    : > /tmp/dhcp.leases
    created_dhcp_lease_file=1
fi
